...
export function login(data) {
	return function(dispatch) {
		...
		axios.post(`${process.env.PROXIMO_URL}/api/v1/auth/local/login`, data)
			.then((response) => {
				dispatch({
...
export function forgottenPassword(data, id) {
	return function(dispatch) {
		...
		axios.post(`${process.env.PROXIMO_URL}/api/v1/auth/local/forgotten/password/${id}`, data)
			.then((response) => {
				dispatch({
...
export function logout() {
	return function(dispatch) {
		...
		axios.get(`${process.env.PROXIMO_URL}/api/v1/auth/local/logout`)
			.then((response) => {
				dispatch({
...
export function register(data) {
	return function(dispatch) {
		...
		axios.post(`${process.env.PROXIMO_URL}/api/v1/auth/local/register/visitor`, data)
			.then((response) => {
				dispatch({
...
export function changePassword(data) {
	return function(dispatch) {
		...
		axios.patch(`${process.env.PROXIMO_URL}/api/v1/auth/local/change/password`, data)
			.then((response) => {
				dispatch({
...
export function changeForgottenPassword(data, id) {
	return function(dispatch) {
		...
		axios.patch(`${process.env.PROXIMO_URL}/api/v1/auth/local/forgotten/change/${id}`, data)
			.then((response) => {
				dispatch({
...
export function getUser(id) {
	return function(dispatch) {
		...
		axios.get(`${process.env.PROXIMO_URL}/api/v1/profile/${id}`)
			.then((response) => {
				dispatch({
...
export function getUserEmail(id) {
	return function(dispatch) {
		...
		axios.get(`${process.env.PROXIMO_URL}/api/v1/auth/local/user/${id}`)
			.then((response) => {
				dispatch({
