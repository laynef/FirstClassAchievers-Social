			...
			<div id="SideMenuComponent">
				<nav id="sideMenu" className="page-sidebar" data-pages="sidebar">
					...
					<div className="sidebar-header">
						<img src="./theme/assets/img/logo_white.png" alt="" className="brand" data-src="./theme/assets/img/logo_white.png" data-src-retina="./theme/assets/img/logo_white_2x.png" width="93" height="25"/>
